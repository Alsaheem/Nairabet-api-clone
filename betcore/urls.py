...
from .views import CategoryViewSet,LeagueViewSet,TeamViewSet,BetViewSet,InPlayBets,MyBetViewSet,UserBets
...
router.register(r'mybets', MyBetViewSet, basename='book')
